...
var OfflineService = /** @class */ (function () {
    ...
    OfflineService.prototype.getConsultarRutas = function (idcobrador, estado) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.db.executeSql("SELECT IDCONTRATO,CEDULA, TITULAR, PAGOHASTA FROM RUTAS WHERE IDCOBRADOR = ? AND ESTADO = ? ", [idcobrador, estado])];
                    case 1:
                        data = _a.sent();
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        d = data_4[_i];
                        return [4 /*yield*/, this.db.executeSql(sql, [d.IDCONTRATO, d.IDPERSONA, d.VALOR, d.DESCUENTO, d.CANTIDADCUOTAS, d.MAQUINA, d.USUARIO, d.OBSERVACIONES, d.CUOTAMENSUAL, d.ESTADO, d.FORMAPAGO, d.FECHAPAGOR, d.POSX, d.POSY, d.TITULAR])];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
