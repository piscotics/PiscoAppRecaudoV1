...
var HomePage = /** @class */ (function () {
    function HomePage(platform, sesionService) {
        ...
        this.platform.ready().then(function () {
            ...
            _this.fechaRuta = localStorage.getItem('fechaRuta');
        });
    }
